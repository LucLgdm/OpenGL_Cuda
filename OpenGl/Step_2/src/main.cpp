...
//  CREATED    : 2025-09-12
//  UPDATED    : 2025-09-12
//  DESCRIPTION: Step 2 OpenGL - Hello Triangle
// ============================================================================
...
void generateVertices(std::vector<float> &vertices,
					...
					ShapeType type, float size = 0.2f, int circleSegments = 32)
{
	vertices.clear();
	indices.clear();
	...
	switch(type) {
		...
		case ShapeType::CIRCLE:
			float centerX = 0.75f, centerY = -0.75f;
...
int main() {
	...
	// generateVertices(vertices, ShapeType::CIRCLE, 0.5f, 64);
	// createShapeVAO(VAO, VBO, vertices);
